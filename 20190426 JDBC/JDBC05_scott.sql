...
INSERT INTO TBL_EMP(EMP_ID, EMP_NAME, SSN, IBSADATE, CITY_ID, TEL, BUSEO_ID, JIKWI_ID, BASICPAY, SUDANG) VALUES (EMPSEQ.NEXTVAL, '정임혜', '901212-2234567', TO_DATE('경기', 'YYYY-MM-DD'), (SELECT CITY_ID FROM TBL_CITY WHERE CITY_LOC ='2017-10-10'), '010-0987-6543', (SELECT BUSEO_ID FROM TBL_BUSEO WHERE BUSEO_NAME='개발부'), (SELECT JIKWI_ID FROM TBL_JIKWI WHERE JIKWI_NAME='사원'), 1000000, 2000000)
