...
--제약조건 삭제 (프라이머리키)
ALTER TABLE TBL_ADMIN DROP PRIMARY KEY;
ALTER TABLE TBL_TEACHERS DROP PRIMARY KEY;
ALTER TABLE TBL_STUDENTS DROP PRIMARY KEY;
ALTER TABLE TBL_COURSE DROP PRIMARY KEY;
ALTER TABLE TBL_STATIC_SUBJECT DROP PRIMARY KEY;
ALTER TABLE TBL_SUBJECT DROP PRIMARY KEY;
ALTER TABLE TBL_OPENCOURSE DROP PRIMARY KEY;
ALTER TABLE TBL_BOOK DROP PRIMARY KEY;
ALTER TABLE TBL_SUGANG DROP PRIMARY KEY;
ALTER TABLE TBL_GIVEUP DROP PRIMARY KEY;
ALTER TABLE TBL_SCORE DROP PRIMARY KEY;
ALTER TABLE TBL_CLASS DROP PRIMARY KEY;
ALTER TABLE TBL_BAEJUM DROP PRIMARY KEY;


--제약조건 삭제(해당 테이블의 컬럼)
ALTER TABLE TBL_ADMIN DROP CONSTRAINT ADMIN_ADMIN_SSN_UK;
ALTER TABLE TBL_TEACHERS DROP CONSTRAINT TEACHERS_TEACHER_SSN_UK;
ALTER TABLE TBL_STUDENTS DROP CONSTRAINT STUDENTS_STUDENT_SSN_UK;
ALTER TABLE TBL_SCORE DROP CONSTRAINT SCORE_SCORE_WR_CH;
ALTER TABLE TBL_SCORE DROP CONSTRAINT SCORE_SCORE_PR_CH;
ALTER TABLE TBL_SCORE DROP CONSTRAINT SCORE_SCORE_AT_CH;
ALTER TABLE TBL_SUBJECT DROP CONSTRAINT SUBJECT_SUB_NAME_CODE_FK;
ALTER TABLE TBL_SUBJECT DROP CONSTRAINT SUBJECT_OPEN_C_CODE_FK;
ALTER TABLE TBL_SUBJECT DROP CONSTRAINT SUBJECT_BOOK_CODE_FK;
ALTER TABLE TBL_OPENCOURSE DROP CONSTRAINT OPENCOURSE_COU_NAME_CODE_FK;
ALTER TABLE TBL_OPENCOURSE DROP CONSTRAINT OPENCOURSE_CLASS_CODE_FK;
ALTER TABLE TBL_OPENCOURSE DROP CONSTRAINT OPENCOURSE_TEACHER_CODE_FK;
ALTER TABLE TBL_SUGANG DROP CONSTRAINT SUGANG_OPNE_C_CODE_FK;
ALTER TABLE TBL_SUGANG DROP CONSTRAINT SUGANG_STUDENT_CODE_FK;
ALTER TABLE TBL_GIVEUP DROP CONSTRAINT GIVEUP_SUGANG_CODE_FK;
ALTER TABLE TBL_SCORE DROP CONSTRAINT SCORE_SUGANG_CODE_FK;
ALTER TABLE TBL_SCORE DROP CONSTRAINT SCORE_SUB_CODE_FK;
ALTER TABLE TBL_BAEJUM DROP CONSTRAINT BAEJUM_SUB_CODE_FK;
